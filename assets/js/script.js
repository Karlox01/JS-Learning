...
function runGame(gameType) {
    ...
    if(gameType === 'addition') {
        ...
        displayDivisionQuestion(num1 * 5, num2)
    } else {
...
function displaySubtractQuestion(operand1, operand2) {
    document.getElementById('operand1').textContent = operand1 > operand2 ? operand1 : operand2; //This means Which is bigger operand1 or op2?,If operand 1 is bigger Return it , If not ret op2
